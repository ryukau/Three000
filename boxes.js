...
var sponge = mengerSponge(new THREE.Vector3(0, 0, 0), 1, 2)
...
function mengerSponge(center, edge_length, depth) {
    if (depth < 1) {
        ...
        var l = edge_length * Math.random()
        var box = new THREE.BoxGeometry(l, l, l, 1, 1, 1)
...
function makeBoxes(boxes) {
    ...
    for (var i = 0; i < boxes.length; ++i) {
        var material = new THREE.MeshLambertMaterial({ color: ramdomColor() })
